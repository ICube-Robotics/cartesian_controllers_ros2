...
#ifndef CARTESIAN_ADMITTANCE_CONTROLLER__CARTESIAN_ADMITTANCE_RULE_IMPL_HPP_
#define CARTESIAN_ADMITTANCE_CONTROLLER__CARTESIAN_ADMITTANCE_RULE_IMPL_HPP_
...
bool AdmittanceRule::get_all_transforms(
  ...
  const cartesian_control_msgs::msg::CartesianTrajectoryPoint & cartesian_reference_state)
{
  bool success = true;
  ...
  //TODO(tpoignonec) admittance_transforms_.ref_base_ft_ = ...
...
)
{
  ...
  bool success = get_all_transforms(current_joint_state, cartesian_reference);
...
#endif  // CARTESIAN_ADMITTANCE_CONTROLLER__ADMITTANCE_RULE_IMPL_HPP_
